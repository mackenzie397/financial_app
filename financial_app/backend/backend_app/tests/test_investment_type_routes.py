...
def test_get_investment_type_other_user(auth_client, client, app):
...
def test_update_investment_type_other_user(auth_client, client, app):
    client1, user1 = auth_client
    post_response = client1.post('/api/investment-types', json={'name': 'User1 Type'})
    investment_type_id = post_response.json['id']
...
def test_delete_investment_type_other_user(auth_client, client, app):
    client1, user1 = auth_client
    post_response = client1.post('/api/investment-types', json={'name': 'User1 Type'})
    investment_type_id = post_response.json['id']
